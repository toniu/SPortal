...
const CalendarApp = (props: ICalendarAppProps) => {
          ...
          <div className="md:pr-14">
            <div className="flex items-center">
              ...
              >
                ...
                <FontAwesomeIcon icon={faChevronLeft} className="w-5 h-5 text-black" aria-hidden="true" />
              </button>
              <button
                onClick={nextMonth}
                type="button"
              ...
              >
                ...
                <FontAwesomeIcon icon={faChevronRight} className="w-5 h-5 text-black" aria-hidden="true" />
              </button>
            </div>
                ...
                >
                  <button
                    ...
                    className={classNames(
                      ...
                      !isSameMonth(day, firstDayCurrentMonth) &&
                      'text-gray-400',
                      isEqual(day, selectedDay) && isToday(day) && 'bg-pink-800',
                      isEqual(day, selectedDay) &&
                      !isToday(day) &&
                      'bg-gray-900',
