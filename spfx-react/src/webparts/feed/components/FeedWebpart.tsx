...
import { IFeedWebpartProps } from './IFeedWebpartProps';
import { IFeedWebpartState } from './IFeedWebpartState';
import SingleStyle from './SingleStyle';
import StackStyle from './StackStyle';
import spservices from './Service/SPServices';

export default class FeedWebpart extends React.Component<IFeedWebpartProps, IFeedWebpartState> {
  private _spservices: spservices;
  constructor(props: IFeedWebpartProps, state: IFeedWebpartState) {
    super(props);
    this.state = {
      SPGuid: '',
      News: [],
  ...
  public componentDidUpdate(prevProps: IFeedWebpartProps) {
...
/*
  ...
  public render(): React.ReactElement<IFeedWebpartProps> {
      ...
      <StackStyle News={this.state.News} AuthorToggle={this.props.AuthorToggle} Reload={this.state.Reload} /> :
      <SingleStyle News={this.state.News} AuthorToggle={this.props.AuthorToggle} Reload={this.state.Reload} />}
    </div>;
  }
}